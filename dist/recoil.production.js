...
function initialStoreState(store, initializeState) {
  ...
  return (
    initializeState &&
      initializeState({
        set: (atom, value) => {
          initial.currentTree = setNodeValue$1(
            store,
            initial.currentTree,
            atom.key,
            value,
        ...
        setUnvalidatedAtomValues: atomValues => {
          atomValues.forEach((v, k) => {
            initial.currentTree = setUnvalidatedAtomValue$1(
              initial.currentTree,
              k,
              v,
            );
...
var Recoil_RecoilValueInterface = {
  ...
  setRecoilValue: function (store, {key: key}, newValue) {
    Recoil_Tracing.trace('set RecoilValue', key, () =>
      store.replaceState(
        Recoil_Tracing.wrap(state => {
          const [newState, writtenNodes] = setNodeValue$2(
            store,
            state,
            key,
            newValue,
    ...
    return useCallback(
      (...args) => {
        ...
        function getLoadable(recoilValue) {
          let result;
          return (
            ([snapshot, result] = getNodeLoadable$2(
              storeRef.current,
              snapshot,
              recoilValue.key,
            )),
...
const {
  ...
  {isRecoilValue: isRecoilValue$1} = require$$2,
      ...
      cacheKey = cacheKeyFromDepValues(
        new Map(
          Array.from(currentDeps)
            .sort()
            .map(depKey => {
              const [nextState, loadable] = getNodeLoadable$3(
                store,
                newState,
                depKey,
              );
    ...
    const [nextState, loadable, newDepValues] = (function (store, state) {
      ...
      const [newStateFromEvaluate, loadable, newDepValues] = (function (
        ...
        function getRecoilValue({key: key}) {
          let loadable;
          if (
            (([newState, loadable] = getNodeLoadable$3(store, newState, key)),
        ...
        function setRecoilState(recoilState, valueOrUpdater) {
          const newValue =
            'function' == typeof valueOrUpdater
              ...
              : valueOrUpdater;
          let written;
          ([newState, written] = setNodeValue$4(
            store,
            newState,
            recoilState.key,
            newValue,
...
const {loadableWithValue: loadableWithValue$2} = Recoil_Loadable,
  ...
  {isRecoilValue: isRecoilValue$2} = require$$2,
  {
  ...
  return {
    ...
    validator: storedValue =>
      storedValue instanceof ParameterizedAtomTaggedValue_DEPRECATED
        ...
        : passthrough.validator(storedValue, DEFAULT_VALUE$4),
  };
}
...
var Recoil_index = {
  ...
  Recoil_index_17 = Recoil_index.useTransactionObservation_UNSTABLE,
  Recoil_index_18 = Recoil_index.useTransactionSubscription_UNSTABLE,
  Recoil_index_19 = Recoil_index.useSetUnvalidatedAtomValues_UNSTABLE,
  Recoil_index_20 = Recoil_index.noWait,
  Recoil_index_21 = Recoil_index.waitForNone,
  Recoil_index_22 = Recoil_index.waitForAny,
  Recoil_index_23 = Recoil_index.waitForAll,
  Recoil_index_24 = Recoil_index.isRecoilValue;
