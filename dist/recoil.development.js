...
} = Recoil_RecoilValue$1; // NOTE: This will not update state with node subscriptions, so use sparingly!!!
...
const {isRecoilValue: isRecoilValue$1} = Recoil_RecoilValue$1;
...
function mapPersistenceSettings_DEPRECATED(settings) {
  ...
  return {
    ...
    validator: storedValue => {
      if (
        storedValue instanceof Recoil_ParameterizedAtomTaggedValue_DEPRECATED
      ) {
        return new Recoil_ParameterizedAtomTaggedValue_DEPRECATED(
          storedValue.value
...
function mapScopeRules(scopeRules, param) {
  return scopeRules === null || scopeRules === void 0
    ? void 0
    : scopeRules.map(rule =>
        Array.isArray(rule)
          ? rule.map(entry =>
